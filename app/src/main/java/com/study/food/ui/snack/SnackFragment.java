...
import com.study.food.adaptor.SnackLeftAdapter;
import com.study.food.adaptor.SnackRightAdapter;
...
public class SnackFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        leftRecyclerview=requireActivity().findViewById(R.id.snackLeftRecyclerView);
        rightRecyclerView=requireActivity().findViewById(R.id.snackRightRecyclerView);
